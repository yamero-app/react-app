...
export default function AnswerModal({ isOpen, setIsOpen }) {
  ...
  const Panel = () => {
    ...
    //   let userObj = [{ que: title, ans: desc }, ...userQuestions];
    //   let feedObj = [{ que: title, ans: desc }, ...feedQuestions];
    ...
    return (
      <form action="#" className="relative">
        ...
        <div className="mt-2 flex text-sm items-center justify-between space-x-3">
          <p>{2500 - ans.length} characters left</p>
          <button
            type="submit"
